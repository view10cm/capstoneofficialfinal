    ...
    <div class="flex min-h-screen bg-gray-50 font-sans">
        ...
        <div class="flex-1 flex flex-col p-8 overflow-y-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div class="bg-white p-6 rounded-xl shadow-sm flex flex-col justify-between h-32">
                    <div class="flex justify-between items-start">
                        <h2 class="text-2xl font-bold text-gray-800">₱{{ number_format($todaysSales ?? 18750, 2) }}</h2> 
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm flex flex-col justify-between h-32">
                    <div class="flex justify-between items-start">
                        <h2 class="text-2xl font-bold text-gray-800">{{ $mealsServed ?? 125 }}</h2>
                        <div class="p-2 bg-orange-100 rounded-lg text-orange-500">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm flex flex-col justify-between h-32">
                    <div class="flex justify-between items-start">
                        <h2 class="text-2xl font-bold text-gray-800">{{ $activeOrders ?? 13 }}</h2>
                        <div class="p-2 bg-orange-100 rounded-lg text-orange-500">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path></svg>
                        </div>
                    </div>
                    <span class="text-gray-900 text-m font-medium">Active Orders</span>
                </div>

                <div class="bg-white p-6 rounded-xl shadow-sm flex flex-col justify-between h-32">
                    <div class="flex justify-between items-start">
                         <h2 class="text-2xl font-bold text-gray-800">{{ $lowStockCount ?? 4 }}</h2>
                        <div class="p-2 bg-orange-100 rounded-lg text-orange-500">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm">
                    <h3 class="font-bold text-gray-800 mb-6">Popular Category</h3>
                        ...
                        <table class="w-full text-left text-sm text-gray-600">
                            <thead>
                                <tr class="border-b border-gray-100 text-gray-900 font-medium">
                                    ...
                                    <th class="pb-3 text-right pr-2">Revenue</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-50">
                                {{-- Placeholder Static Data: Wrap this in @foreach later --}}
                                <tr class="hover:bg-gray-50">
                                    <td class="py-3 pl-2 font-bold text-gray-800">1</td>
                                    <td class="py-3 font-medium text-gray-800">Beef</td>
                                    <td class="py-3">Meat</td>
                                    <td class="py-3 text-center">357</td> 
                                    <td class="py-3 text-right pr-2">₱1,450.00</td>
                                </tr>
                                <tr class="hover:bg-gray-50">
                                    <td class="py-3 pl-2 font-bold text-gray-800">2</td>
                                    <td class="py-3 font-medium text-gray-800">Oxtail</td>
                                    <td class="py-3">Meat</td>
                                    <td class="py-3 text-center">331</td>
                                    <td class="py-3 text-right pr-2">₱2,100.00</td>
                                </tr>
                                <tr class="hover:bg-gray-50">
                                    <td class="py-3 pl-2 font-bold text-gray-800">3</td>
                                    <td class="py-3 font-medium text-gray-800">Garlic</td>
                                    <td class="py-3">Vegetable</td>
                                    <td class="py-3 text-center">210</td>
                                    <td class="py-3 text-right pr-2">₱400.00</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left text-sm text-gray-600">
                            ...
                            <tbody class="divide-y divide-gray-50">
                                {{-- Placeholder Static Data: Wrap this in @foreach later --}}
                                <tr class="hover:bg-gray-50">
                                    <td class="py-3 pl-2 font-medium text-gray-800">Beef</td>
                                    <td class="py-3">15 kg</td>
                                    <td class="py-3 text-right pr-2 text-green-500 font-medium">In Stock</td>
                                </tr>
                                <tr class="hover:bg-gray-50">
                                    <td class="py-3 pl-2 font-medium text-gray-800">Oxtail</td>
                                    <td class="py-3">5 pcs</td>
                                    <td class="py-3 text-right pr-2 text-yellow-500 font-medium">Low Stock</td>
                                </tr>
                                <tr class="hover:bg-gray-50">
                                    <td class="py-3 pl-2 font-medium text-gray-800">Garlic</td>
                                    <td class="py-3">1 kg</td>
                                    <td class="py-3 text-right pr-2 text-yellow-500 font-medium">Low Stock</td>
                                </tr>
                            </tbody>
                        </table>
