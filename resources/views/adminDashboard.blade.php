            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-5">
                <div class="bg-white p-4 rounded-xl shadow-sm flex flex-col justify-between h-24">
                    <div class="flex justify-between items-start">
                        ...
                        <h2 class="text-xl font-bold text-gray-800">₱{{ number_format($todaysSales, 2) }}</h2> 
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm flex flex-col justify-between h-24">
                    <div class="flex justify-between items-start">
                        {{-- Dynamic Meals Served --}}
                        <h2 class="text-xl font-bold text-gray-800">{{ $mealsServed }}</h2>
                        <div class="p-2 bg-orange-100 rounded-lg text-orange-500">
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm flex flex-col justify-between h-24">
                    <div class="flex justify-between items-start">
                        {{-- Dynamic Active Orders --}}
                        <h2 class="text-xl font-bold text-gray-800">{{ $activeOrders }}</h2>
                        <div class="p-2 bg-orange-100 rounded-lg text-orange-500">
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm flex flex-col justify-between h-24">
                    <div class="flex justify-between items-start">
                        ...
                        <h2 class="text-xl font-bold text-gray-800">{{ $lowStockCount }}</h2>
                        <div class="p-2 bg-orange-100 rounded-lg text-orange-500">
