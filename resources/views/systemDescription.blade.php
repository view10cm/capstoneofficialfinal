...
<head>
    <meta charset="UTF-8">
    <title>System Description - Caffe Arabica</title>
...
<body class="bg-amber-50 min-h-screen relative overflow-hidden select-none cursor-pointer"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function playAudio() {
                if ('speechSynthesis' in window) {
                    ...
                    // Redirect on End (IMPORTANT: Only redirect when audio finishes)
                    speech.onend = () => {
                        proceedToNextPage();
                    };
            ...
            // 1. "Tap to Skip" - Any click on the body skips immediately
